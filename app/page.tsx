...
import { Download, Share, Code, MessageCircle , Copy, CheckCheck, Eye} from 'lucide-react';
...
function WorkflowActions({ workflow, onPreview }: { workflow: WorkflowType | null, onPreview: () => void }) {
